...
더 크게 보려면 [PDF 버전](설문조사_대시보드.pdf)에서도 확인할 수 있다.
...
| 제안 | 근거 | 방향 |
|---|---|---|
| 사이즈/핏·정보 신뢰성 보강 | 선택형 불만 1위(사이즈 102) · 자유응답 42.4% 최다 | 실측·착용 후기·체형별 리뷰 정보 노출 검토 |
| 소극적 잔류층 만족도 개선 | 잔류 의향 93.5% vs NPS -32 | Detractor 불만 원인·추천 저해 요인 추적 |
| 재구매·재활성화 요인 점검 | 멀티호밍 81% · 구매 공백률 15.7% | 객단가 신호 높은 구매 공백 고객 재활성화 검토 |
